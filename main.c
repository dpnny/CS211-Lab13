/*
    Program 1: Wumpus, version 1
 
       *** This version has errors, for you to find using a GUI debugger. ***
...
int roomIsAdjacent( const int tunnels[ 3],  // Array of adjacent tunnels
...
int main(void) {
    ...
    while (personIsAlive && wumpusIsAlive) {
        ...
        gameInfo.moveNumber = gameInfo.moveNumber;
